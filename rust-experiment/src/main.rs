...
static OPERATIONS: &'static [fn(i128) -> i128] = &[
    lu,ld,ru,rd,fl,fr,bl,br,ul,ur,dl,dr
];
...
fn fl(x: i128) -> i128 {
    return ((x & 0x7000000000000000) << 9)|((x & 0xff8000000000000000) >> 3)|((x & 0xfc0ffffc0e381c7) << 0)|((x & 0x38) << 48)|((x & 0x1c0000) << 30)|((x & 0xe00) << 18)|((x & 0x7000) << 12)|((x & 0x7000000) >> 6)|((x & 0x7000000000000) >> 36)|((x & 0x38000000000000) >> 42)|((x & 0x38000000) >> 24);
}

fn fr(x: i128) -> i128 {
    return ((x & 0x1ff000000000000000) << 3)|((x & 0xe00000000000000000) >> 9)|((x & 0xfc0ffffc0e381c7) << 0)|((x & 0xe00) << 42)|((x & 0x7000) << 36)|((x & 0x38) << 24)|((x & 0x1c0000) << 6)|((x & 0x7000000000000) >> 30)|((x & 0x7000000) >> 12)|((x & 0x38000000) >> 18)|((x & 0x38000000000000) >> 48);
}

fn bl(x: i128) -> i128 {
    return ((x & 0xfff03f00003f1c7e38) << 0)|((x & 0x7) << 57)|((x & 0xe00000) << 33)|((x & 0x7000000000) << 9)|((x & 0xff8000000000) >> 3)|((x & 0x1c0) << 27)|((x & 0x38000) << 15)|((x & 0x1c0000000) >> 9)|((x & 0x1c0000000000000) >> 39)|((x & 0xe00000000000000) >> 51)|((x & 0xe00000000) >> 33);
}

fn br(x: i128) -> i128 {
    return ((x & 0xfff03f00003f1c7e38) << 0)|((x & 0x1c0) << 51)|((x & 0x38000) << 39)|((x & 0x1ff000000000) << 3)|((x & 0xe00000000000) >> 9)|((x & 0x7) << 33)|((x & 0xe00000) << 9)|((x & 0x1c0000000000000) >> 33)|((x & 0x1c0000000) >> 15)|((x & 0xe00000000) >> 27)|((x & 0xe00000000000000) >> 57);
}
